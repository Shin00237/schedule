...
class ObjectiveWeightScenariosTest {
    ...
    void testWeightHierarchy() {
        ...
        assertTrue(ObjectiveWeight.MAXIMIZE_CRITICAL.getWeight() > ObjectiveWeight.MAXIMIZE_HIGH.getWeight());
        assertTrue(ObjectiveWeight.MAXIMIZE_HIGH.getWeight() > ObjectiveWeight.MAXIMIZE_MEDIUM.getWeight());
        assertTrue(ObjectiveWeight.MAXIMIZE_MEDIUM.getWeight() > ObjectiveWeight.MAXIMIZE_LOW.getWeight());
        
        // CRITICAL < HIGH < MEDIUM < LOW pour minimisation (valeurs négatives)
        assertTrue(ObjectiveWeight.MINIMIZE_CRITICAL.getWeight() < ObjectiveWeight.MINIMIZE_HIGH.getWeight());
        assertTrue(ObjectiveWeight.MINIMIZE_HIGH.getWeight() < ObjectiveWeight.MINIMIZE_MEDIUM.getWeight());
        assertTrue(ObjectiveWeight.MINIMIZE_MEDIUM.getWeight() < ObjectiveWeight.MINIMIZE_LOW.getWeight());
    ...
    void testCriticalDominatesOtherLevels() {
        ...
        assertEquals(Math.abs(ObjectiveWeight.MINIMIZE_CRITICAL.getWeight()), maxCritical,
    ...
    void testScenarioCriticalViolationStopsOptimization() {
        ...
        assertTrue(totalObjective <= maximizeWeight, 
    ...
    void testScenarioMultipleLevelBalance() {
        ...
        assertTrue(objective < 50 * ObjectiveWeight.MAXIMIZE_CRITICAL.getWeight(),
