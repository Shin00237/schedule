...
/**
 * Configuration pour définir la structure temporelle du planning.
 * Permet de supporter différents types de cycles de travail.
 */
public class SchedulingConfiguration {
  ...
  public SchedulingConfiguration(int daysPerCycle, List<DayOfWeek> cyclePattern, String displayName) {
    if (daysPerCycle <= 0) {
      throw new IllegalArgumentException("daysPerCycle doit être positif");
    }
    if (cyclePattern.size() != daysPerCycle) {
      throw new IllegalArgumentException("cyclePattern doit contenir exactement " + daysPerCycle + " jours");
    }
   ...
   */
  public static final SchedulingConfiguration STANDARD_WEEK = new SchedulingConfiguration(
    7, 
   ...
   */
  public static final SchedulingConfiguration WEEKDAYS_ONLY = new SchedulingConfiguration(
    5,
    List.of(DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY, 
   ...
   */
  public static final SchedulingConfiguration SIX_DAYS_WEEK = new SchedulingConfiguration(
    6,
    List.of(DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY, 
