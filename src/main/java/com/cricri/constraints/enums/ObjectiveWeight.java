 ...
 *
 * <p>Cette enum définit les différents niveaux de priorité pour les contraintes souples : - Poids
 * positifs pour maximiser (ex: heures travaillées) - Poids négatifs pour minimiser (ex: violations
 * de contraintes)
 *
 * <p>Les valeurs sont calibrées pour permettre une hiérarchisation claire : CRITICAL > HIGH >
 * MEDIUM > LOW
 */
