 ...
 * 
 * Cette énumération facilite la configuration depuis une interface graphique en proposant
 * des choix explicites plutôt que des valeurs numériques arbitraires.
 */
