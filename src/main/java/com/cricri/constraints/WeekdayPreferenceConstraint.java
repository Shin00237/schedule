 ...
 *
 * <p>Cette contrainte favorise l'assignation durant les jours de semaine (lundi à vendredi) plutôt
 * que le weekend (samedi, dimanche).
 *
 * <p>Remplace l'ancien WeekdayPreferenceObjective du package objectives.
 */
public class WeekdayPreferenceConstraint implements Constraint {
  ...
  public WeekdayPreferenceConstraint(
      int multiplier, ConstraintNature nature, ConstraintPriority priority) {
